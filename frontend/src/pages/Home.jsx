  ...
  return (
    <>
        ...
        <div className="impacts">
          <h1>Where's the Harm?</h1>
          <p className="impacts-text">
        ...
        <div className="solution">
          <h1> The Solution</h1>
          <p>
          If users actively participate in keeping the streets clean through the Urban Unblemished app, this will cause a major shift in NYC pollution. By providing an informative, inspiring and user-friendly interface, and fostering volunteer engagement, Urban Unblemished aims to hold space for individuals interested in discussing and contributing to street cleanliness and community building.
